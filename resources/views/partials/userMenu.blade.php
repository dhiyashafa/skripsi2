<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link {{ request()->is("user") ? "active" : "" }}" href="{{ route("admin.home") }}">
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{ trans('cruds.smart.title') }}</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ request()->is("user") ? "active" : "" }}" href="{{ route("kriteria.index") }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-primary text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-fw fa-tachometer-alt"></i>
          </div>
          <span class="nav-link-text ms-1">{{ trans('cruds.kriteria.title') }}</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ request()->is("user") ? "active" : "" }}" href="{{ route("alternatif.index") }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-primary text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-fw fa-tachometer-alt"></i>
          </div>
          <span class="nav-link-text ms-1">{{ trans('cruds.alternatif.title') }}</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ request()->is("user") ? "active" : "" }}" href="{{ route("perhitungan.index") }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-primary text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-fw fa-tachometer-alt"></i>
          </div>
          <span class="nav-link-text ms-1">{{ trans('cruds.perhitungan.title') }}</span>
        </a>
      </li>
